...
cfg.train.rand_scaler = RandScaler(min_scale=0.5, max_scale=1.5, patch_size=512)
...
# validation
cfg.valid = DotDict()
cfg.valid.rand_scaler = RandScaler(min_scale=0.5, max_scale=1.5, patch_size=512)
